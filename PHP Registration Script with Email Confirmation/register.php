...
if(isset($_POST["register"])) {
 ...
 if($no_of_row > 0) {
  ...
  if(isset($result)) {
    // echo 'Done!';
    // die();
   $base_url = "http://localhost/advanced-bootcamp-WEB-DEVELOPMENT/PHP%20Registration%20Script%20with%20Email%20Confirmation/";
   $mail_body = "
   ...
   $mail->Username = 'lucasgabule@gmail.com';     //Sets SMTP username
   $mail->Password = 'paranormallovemagnoliapa24programmer2k17';     //Sets SMTP password
   $mail->SMTPSecure = 'ssl';       // Sets connection prefix. Options are "", "ssl" or "tls"
   $mail->From = 'lucasgabule@gmail.com';   //Sets the From email address for the message
   $mail->FromName = 'John Paul Lim Gabule';     //Sets the From name of the message
